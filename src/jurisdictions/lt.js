...
export class LTAdapter extends BaseJurisdictionAdapter {
  get baseUrl() { return "https://www.registrucentras.lt"; }
  get searchUrl() { return "https://www.registrucentras.lt/jar/paieska"; }

  get selectors() {
    return {
      searchInput: "input[name='pav']",
  ...
  extractSearchResults(html) {
    ...
    // TODO: map to actual LT registry HTML structure
  ...
  extractCompanyDetail(_html) {
    // TODO: implement LT company detail extraction
    return [];
  }
}
